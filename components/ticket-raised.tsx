            ...
            <div className=' w-[100%] p-3 bg-[#fff] rounded-[12px] '>
                <div className=' flex flex-col gap-5'>
                    <div className=' border-[#000] flex justify-between '>
                        <div className='border-8 border-[#153453] bg-[#356A9F] w-[48px] h-[48px] rounded-[50%]  flex justify-center items-center'>
                            <Image src="/images/a2_icons.png" alt='icon' width={20} height={17} />
                        </div>
