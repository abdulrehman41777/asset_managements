...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 bg-gray-100">
      {/* Outer grid: left column is fixed at 332px on large screens, no big fixed height */}
      <div className="grid grid-cols-1 lg:grid-cols-[332px_1fr] gap-4">
        ...
        <div className="grid grid-rows-2 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-md">
            ...
            {/* Small AreaChart with minimal spacing */}
        ...
        <div className="bg-white rounded-lg shadow-md flex flex-col">
          ...
          {/* Legend row (Open Rate & Completed) */}
          ...
          {/* BarChart fills the remaining space */}
